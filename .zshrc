...
alias tbd2='docker run --rm -t -p 6108:6108 -v $PWD:/workspace  tensorflow/tensorflow tensorboard --logdir /workspace --port 6108 --bind_all'
alias tbd3='docker run --rm -t -p 6109:6109 -v $PWD:/workspace  tensorflow/tensorflow tensorboard --logdir /workspace --port 6109 --bind_all'
alias tbd4='docker run --rm -t -p 6110:6110 -v $PWD:/workspace  tensorflow/tensorflow tensorboard --logdir /workspace --port 6110 --bind_all'
